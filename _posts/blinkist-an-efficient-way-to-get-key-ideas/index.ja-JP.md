...
Blinkistには現在、27のカテゴリをカバーする5,000冊以上のノンフィクションの本が含まれています。興味のあるトピックを簡単に見つけるか、[Blinkist](https://blinkist.o6eiov.net/gbadgg) にアクセスしてどれを確認してください。彼らが含めた本。
...
* 電子書籍を読むことに慣れている場合は、[記事をKindleに送信](https://blinkist.o6eiov.net/zandr0)、実行中の問題はありません。
