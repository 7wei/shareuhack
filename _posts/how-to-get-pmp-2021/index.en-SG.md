...
recommendations:
  [
    ...
    },
    {
      ...
      link: 'https://tinyurl.com/ydms725t',
      src: 'Kinokuniya'
    },
  ]
references:
...
5. [Head First PMP: A Learner's Companion to Passing the Project Management Professional Exam](https://tinyurl.com/ydms725t): Head First PMP use interesting and inspiring way to help you understand, learn the PMP knowledge framework. Not only for the exam, it is also a good book for acquiring new knowledge.
