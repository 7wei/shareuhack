      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Shareuhack.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Shareuhack, accessible from
            <a href="https://www.shareuhack.com" rel="external nofollow noopener" target="_blank">
